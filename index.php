<?php
/**
 * Index Template - Blog listing page for LVM CRM
 * Used for the main blog page
 */
...
<div class="min-h-screen bg-background text-foreground">
  ...
  <!-- Hero Section -->
  <section class="relative pt-32 pb-16 lg:pt-36 lg:pb-20 bg-gradient-to-b from-primary/[0.03] to-transparent">
    <div class="max-w-6xl mx-auto px-6">
      <div class="blog-hero-content max-w-2xl">
        <span class="inline-flex items-center mb-4 text-[13px] text-primary font-medium tracking-wide">
          ...
          <?php esc_html_e('LVM CRM Blog', 'crm-lvm'); ?>
        </span>
        
        <h1 class="text-4xl md:text-5xl font-bold tracking-tight mb-6 leading-[1.1] text-foreground">
          <?php esc_html_e('Insights & Resources', 'crm-lvm'); ?>
        </h1>
        
        <p class="text-lg text-muted-foreground leading-relaxed">
          <?php esc_html_e('Tips, strategies, and insights to help Maryland business owners grow with CRM, automation, and smart marketing.', 'crm-lvm'); ?>
        </p>
      </div>
    </div>
  </section>
    ...
    <div class="max-w-6xl mx-auto px-6">
      <?php if (have_posts()) : ?>
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <?php while (have_posts()) : the_post(); ?>
            <article class="blog-card group bg-card rounded-2xl border border-border/50 overflow-hidden hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 transition-all duration-300">
              <!-- Featured Image -->
      ...
      <?php else : ?>
        ...
        <div class="text-center py-16">
          ...
          <h2 class="text-xl font-semibold text-foreground mb-2"><?php esc_html_e('No posts yet', 'crm-lvm'); ?></h2>
          <p class="text-muted-foreground text-[15px]"><?php esc_html_e('Check back soon for new content.', 'crm-lvm'); ?></p>
        </div>
      <?php endif; ?>
    </div>
  </section>
