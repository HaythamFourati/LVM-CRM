      ...
      <?php while (have_posts()) : the_post(); ?>
        ...
        <div class="mt-12 p-6 rounded-2xl bg-secondary/30 border border-border">
          <h3 class="text-xl font-semibold text-foreground mb-2">
            <?php esc_html_e('Questions About Our Privacy Policy?', 'crm-lvm'); ?>
          </h3>
          <p class="text-muted-foreground mb-4">
            <?php esc_html_e('If you have any questions or concerns about our privacy practices, please contact us.', 'crm-lvm'); ?>
          </p>
