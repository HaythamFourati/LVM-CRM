<?php
/**
 * Single Blog Post Template - LVM CRM Modern Design
 */
...
<div class="min-h-screen bg-background text-foreground">
  ...
  <article class="single-post">
    <header class="pt-32 pb-12 lg:pt-36 lg:pb-16 bg-gradient-to-b from-primary/[0.03] to-transparent">
      <div class="max-w-3xl mx-auto px-6">
        <div class="single-post-header">
          <!-- Back Link & Category -->
          <div class="flex items-center gap-6 mb-6">
            <a href="<?php echo home_url('/blog'); ?>" class="inline-flex items-center gap-2 text-[13px] text-primary font-medium hover:text-primary/80 transition-colors">
              ...
              <?php esc_html_e('Back to Blog', 'crm-lvm'); ?>
            </a>
            <?php 
        ...
        <div class="flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-[14px] text-muted-foreground leading-relaxed">
              <?php echo get_the_author_meta('description') ?: esc_html__('Helping Maryland business owners grow with CRM, automation, and smart marketing strategies.', 'crm-lvm'); ?>
            </p>
          </div>
        </div>
      </div>
